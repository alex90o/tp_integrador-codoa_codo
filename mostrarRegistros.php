                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="listaAgentes" class="table text-center" style="width:100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="center d-flex justify-content-between">
                                                                <div class="col-sm">
                                                                    <form
                                                                        action="">
                                                                        <input name="txtAgente" type="hidden"
                                                                            value="{{ $agente->documento }}">
                                                                        <button type="submit"
