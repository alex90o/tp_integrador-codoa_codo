...
<html lang="es">
  ...
  <h3>Login de usuario admin</h3>
<?php
if ($email == "admin@gmail.com" && $password == "admin")
{
    echo "<h4>Usuario Correcto</h4>";
    echo'<img class="img-fluid" src="img/guardado_correcto.png" alt="usuario_correcto">';
    echo "<h4>El password fue  $password</h4>" ;
    echo "<h4>El email es  $email</h4>";
}
else{
    echo "<h4>Usuario Incorrecto !!!</h4>";
    echo'<img class="img-fluid" src="img/guardado_incorectocorrecto.png" alt="usuario_correcto">';
}
?>
       </div>
      </div>
